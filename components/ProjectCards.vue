  ...
  <div class="projCards">
    ...
    <div class="first hero">
      <img
        ...
        src="../assets/images/werewolfImg.png"
        alt
      />
      <div class="hero-description-bk werewolfCard"></div>
      <div class="hero-logo">
        <img
      ...
      <div class="hero-description">
        <p>Mimicked werewolf/mafia game, using Vuejs & Vuetify.</p>
      </div>
      <div class="hero-date">
        <p>03.15.2020</p>
      </div>
    ...
    <div class="first hero">
      ...
      <div class="hero-description">
        <p>Check weather around the world, using ReactJS.</p>
      </div>
      <div class="hero-date">
        <p>03.15.2020</p>
      </div>
...
.hero-description-bk {
  /* background-image: linear-gradient(0deg , #3f5efb, #F22F46); */
  border-radius: 30px;
  position: absolute;
  top: 55%;
  left: -5px;
...
.jayCard {
  background-image: linear-gradient(0deg, black, #34aef0);
}
.ballCard {
  background-image: linear-gradient(0deg, black, #96e5ed);
}
.werewolfCard {
